...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parsing_header_bonus.h                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jdelsol- <jdelsol-@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/08 18:11:34 by cormiere          #+#    #+#             */
/*   Updated: 2023/09/13 18:34:00 by jdelsol-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef PARSING_HEADER_BONUS_H
# define PARSING_HEADER_BONUS_H
...
char		**ft_check_file_content(char *file, int fd, char *line,
				char **content);
...
int			ft_check_vertical_multiple_map(char **map, const int len,
				int end_line, int j);
